...
{
  private static String  _id = "IDL:Cell/bytes:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (ru.bmstu.rk6.cell.stub.bytesHelper.id (), "bytes", __typeCode);
    }
    return __typeCode;
  }
