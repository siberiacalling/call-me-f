...
class TubeCallbackServant extends TubeCallbackPOA
{
    ...
    public void sendSMS(String fromNum, String message)
    {
        System.out.println("Tube-"+this.myNum+": get message from phone #"+fromNum+": "+message);
    }
...
public class Tube
{
    public static void main(String args[])
    {
        try
        {
	    //System.out.println("New Tube create:"+args[4]);
            ...
            System.out.println("Tube-"+myNum+" was registered by Server");
